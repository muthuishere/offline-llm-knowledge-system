            ...
            <div style={modalStyles.body}>
              {infoTab === 'functional' ? (
                ...
                <>
                  ...
                  <div style={modalStyles.techItem}><span style={modalStyles.techLabel}>Chat model (GPU or CPU)</span>GPU models: WebLLM loads safetensors from Cache API via WebGPU. CPU models: wllama loads GGUF from OPFS via llama.cpp WASM — works everywhere, no GPU needed.</div>
